...
public class Player implements ActionListener{
    ...
    private boolean forward, backward, left, right, isCrouched;
    InputManager inputManager;
    
    public Player(Camera cam, BulletAppState bullet, Main main){
        forward = backward = left = right = isCrouched = false;
        this.main = main;
    ...
    if (binding.equals("Left")) {
      ...
      if (!isPressed) {
        ...
        //test.
        test.controller.getRigidBodyControl().setLinearVelocity(cam.getDirection().mult(2));
      }
    }
